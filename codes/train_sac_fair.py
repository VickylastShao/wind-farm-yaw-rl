"""SAC fair comparison — matched budget & config with PPO Config-E."""
...
class Actor(nnx.Module):
    ...
    def deterministic(self, obs): return jnp.tanh(self.net(obs)) * ACT_BOUND
...
for seed in range(N_SEEDS):
    ...
    print(f'  obs_dim={od} act_dim={ad} iterations={ni} per_iter={per_iter} total={ni*per_iter}'); sys.stdout.flush()
