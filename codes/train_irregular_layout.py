...
def train_one_seed(seed: int) -> dict:
    ...
    positions_list = [[49.3,34.9,0],[927.6,6.5,0],[1750.7,-11.8,0],[1323.0,819.0,0],[3058.7,945.0,0],[441.0,1638.0,0],[1764.0,1764.0,0],[3528.0,1701.0,0],[4851.0,1890.0,0]]; _, _ = 3, 3
